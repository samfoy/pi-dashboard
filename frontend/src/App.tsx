...
const NAV_ITEMS = [
  ...
  { path: '/loops', id: 'loops', label: 'Loops', group: 'Tools', icon: <><path d="M21 12a9 9 0 1 1-6.219-8.56" /><polyline points="21 3 21 12 12 12" /></> },
...
export default function App() {
  ...
  return (
    ...
    <div className={`pidash-root relative z-[1] h-[100dvh] grid grid-rows-[52px_1fr_auto] md:grid-rows-[52px_1fr] grid-cols-[1fr] animate-rise overflow-hidden transition-[grid-template-columns] duration-[350ms] ease-in-out ${navCollapsed ? 'md:grid-cols-[56px_minmax(0,1fr)]' : 'md:grid-cols-[220px_minmax(0,1fr)]'}`}>
      ...
      {/* Topbar */}
      <header className="pidash-topbar topbar-glass flex justify-between items-center px-3 md:px-5 pl-[max(0.75rem,env(safe-area-inset-left,0.75rem))] md:pl-[max(1.25rem,env(safe-area-inset-left,1.25rem))] z-40 standalone-pad md:col-span-2 hidden md:flex">
